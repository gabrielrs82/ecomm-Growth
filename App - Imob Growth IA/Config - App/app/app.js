...
async function fetchAndRenderAds() {
    ...
    try {
        ...
        const res = await fetch("/api/fetch-ads", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
...
function renderAdsGrid() {
    ...
    gridContainer.innerHTML = warningBanner + filtered.map(ad => {
        ...
        if (ad.tipo_midia === "VIDEO" && ad.videoUrl) {
            ...
            mediaHtml = `
                <img src="${ad.imageUrl || '/Assets/real_estate_1.png'}" alt="${ad.titulo || ''}" onerror="this.src='/Assets/real_estate_1.png'" style="width:100%; height:100%; object-fit:cover; display:block;">
            `;
        }
...
const TEMPLATE_GALLERY = [
    ...
    // ── MCMV ──────────────────────────────────────────────────────
    {
        ...
        htmlOverlay: true,
        bgImage: '/Assets/mcmv_mrv.png.jpeg',
        fields: [
...

    {
        ...
        htmlOverlay: true,
        height: 1080,
        bgImage: '/Assets/lar_feliz_dresden.png',
        fields: [
    ...
    // ── PLANTA E PRECO ────────────────────────────────────────────
    {
        ...
        htmlOverlay: true,
        height: 1350,
        bgImage: '/Assets/planta_preco_example.png',
        fields: [
...

    {
        ...
        htmlOverlay: true,
        bgImage: '/Assets/adolfo_pinheiro_fachada_perspectiva_ilustrada.jpg',
        fields: [
...

    {
        ...
        htmlOverlay: true,
        bgImage: '/Assets/adolfo_pinheiro_template_exemplo.png',
        fields: [
            { id: 'tagline_linha1', label: 'Tagline Linha 1', placeholder: 'ex: More a 2 min.', default: 'More a 2 min.' },
            { id: 'tagline_linha2', label: 'Tagline Linha 2', placeholder: 'ex: da Estação', default: 'da Estação' },
            { id: 'titulo', label: 'Título', placeholder: 'ex: ADOLFO\\nPINHEIRO', default: 'ADOLFO\nPINHEIRO' },
            ...
            { id: 'totem_texto', label: 'Texto no Totem', placeholder: 'ex: Adolfo Pinheiro', default: 'Adolfo Pinheiro' },
            { id: 'imagem1', label: 'Imagem 1 (Prédio)', type: 'file', placeholder: 'Upload...', default: '/Assets/real_estate_1.png' },
            { id: 'imagem2', label: 'Imagem 2 (Lounge)', type: 'file', placeholder: 'Upload...', default: '/Assets/real_estate_2.png' },
            { id: 'imagem3', label: 'Imagem 3 (Fachada)', type: 'file', placeholder: 'Upload...', default: '/Assets/real_estate_3.png' },
            { id: 'imagem4', label: 'Imagem 4 (Piscina)', type: 'file', placeholder: 'Upload...', default: '/Assets/real_estate_4.png' }
        ],
        defaults: {
            tagline_linha1: 'More a 2 min.',
            tagline_linha2: 'da Estação',
            ...
            valor_renda: '4.000',
            totem_texto: 'Adolfo Pinheiro',
            imagem1: '/Assets/real_estate_1.png',
            imagem2: '/Assets/real_estate_2.png',
            imagem3: '/Assets/real_estate_3.png',
            imagem4: '/Assets/real_estate_4.png'
        }
    },

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/alto_eliseos_template_exemplo.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/americas_19_recreio_shopping_.jpg',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/lazer_clube.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/apartamento_equipado.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/nova_iraja_residencial.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/mitz_de_luca.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/jacana_zn_imovel.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/jr_prime_vila_re.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/jurubatuba_evoque.png',
        fields: [
            { id: 'foto_predio', label: 'Foto do Prédio (Fundo)', type: 'file', placeholder: 'Upload...', default: '/Assets/jurubatuba_evoque.png' },
            { id: 'foto_vaga_carro', label: 'Foto Vaga de Carro', type: 'file', placeholder: 'Upload...', default: '/Assets/real_estate_1.png' },
            { id: 'foto_vaga_moto', label: 'Foto Vaga de Moto', type: 'file', placeholder: 'Upload...', default: '/Assets/real_estate_2.png' },
            { id: 'foto_varanda', label: 'Foto Varanda', type: 'file', placeholder: 'Upload...', default: '/Assets/real_estate_3.png' },
        ...
        defaults: {
            foto_predio: '/Assets/jurubatuba_evoque.png',
            foto_vaga_carro: '/Assets/real_estate_1.png',
            foto_vaga_moto: '/Assets/real_estate_2.png',
            foto_varanda: '/Assets/real_estate_3.png',
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/castello_di_lorenzo.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/lancamento_centro_niteroi.jpg',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/chacara_santo_antonio.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/conceito_california.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/conexao_anhembi.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/casa_fortaleza.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/santa_marina.png',
        fields: [
...

    {
        ...
        category: 'mcmv',
        htmlOverlay: true,
        bgImage: '/Assets/1787323094648_image.png',
        fields: [
    ...
    if (btnDebug) {
        btnDebug.addEventListener('click', () => {
            ...
            const defaultBg = isPlanta
                ? '/Assets/planta_preco_example.png'
                : (templateObj && templateObj.bgImage ? templateObj.bgImage : '/Assets/lar_feliz_dresden.png');
...
function renderInteractiveOverlay() {
    ...
    if (category === 'mcmv') {
        ...
        if (selectedTemplateId === 'planta-mcmv') {
            ...
            const imgVagaCarro = (window._templateUploadedImages && window._templateUploadedImages['foto_vaga_carro']) || '/Assets/real_estate_1.png';
            const imgVagaMoto  = (window._templateUploadedImages && window._templateUploadedImages['foto_vaga_moto'])  || '/Assets/real_estate_2.png';
            const imgVaranda   = (window._templateUploadedImages && window._templateUploadedImages['foto_varanda'])   || '/Assets/real_estate_3.png';
            ...
            const img1 = (window._templateUploadedImages && window._templateUploadedImages['imagem1']) || '/Assets/real_estate_1.png';
            const img2 = (window._templateUploadedImages && window._templateUploadedImages['imagem2']) || '/Assets/real_estate_2.png';
            const img3 = (window._templateUploadedImages && window._templateUploadedImages['imagem3']) || '/Assets/real_estate_3.png';
            const img4 = (window._templateUploadedImages && window._templateUploadedImages['imagem4']) || '/Assets/real_estate_4.png';
    ...
    if (approvalImg) {
        ...
        if (!targetBg) {
            targetBg = window.lastGeneratedBgImage || aiRawImageUrl || ((templateObj && templateObj.bgImage) ? templateObj.bgImage : '/Assets/lancamento_centro_niteroi.jpg');
        }
...
function addMcmvLogoToArtboard(num) {
    const logoSrc = num === 1 ? '/Assets/mcmv_logo_1.png' : '/Assets/mcmv_logo_2.png';
...
function addHisSpLogoToArtboard() {
    const logoSrc = '/Assets/his_sp.png';
...
function addPlacaMetroToArtboard() {
    const logoSrc = '/Assets/placa_metro.png';
