        ...
        aiBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                if (templateObj && templateObj.htmlOverlay) {
                    ...
                    } else if (selectedTemplateId === 'lar-feliz' || selectedTemplateId === 'sonho-realizado' || selectedTemplateId === 'adolfo-pinheiro' || selectedTemplateId === 'adolfo-pinheiro-original' || selectedTemplateId === 'alto-eliseos' || selectedTemplateId === 'recreio-shopping' || selectedTemplateId === 'lazer-clube' || selectedTemplateId === 'castello-di-lorenzo' || selectedTemplateId === 'lancamento-centro-niteroi' || selectedTemplateId === 'ver-klabin' || selectedTemplateId === 'chacara-santo-antonio' || selectedTemplateId === 'conceito-california' || selectedTemplateId === 'conexao-anhembi' || selectedTemplateId === 'bonsucesso' || selectedTemplateId === 'casa-fortaleza' || selectedTemplateId === 'guaianases' || selectedTemplateId === 'santa-marina') {
                        // Lar Feliz, Minha Casa MCMV, Adolfo Pinheiro, Alto Elíseos, Castello Di Lorenzo, Lançamento Centro Niterói, Ver Klabin, Chácara Santo Antônio, Conceito Califórnia, Conexão Anhembi e Bonsucesso usam composição de layers atômicos
                        renderInteractiveOverlay();
                    } else {
                        renderMCMVOverlay(custom_fields, brandC1, brandC2, brandFont);
                    }
                    showEditorProView();
...
window.rebuildCurrentTemplateOverlay = function() {
    ...
    if (selectedTemplateId === 'planta-mcmv') {
        ...
        renderInteractiveOverlay();
    } else if (templateObj && templateObj.htmlOverlay) {
        renderMCMVOverlay(custom_fields, brandC1, brandC2, brandFont);
    } else {
        renderInteractiveOverlay();
    }
